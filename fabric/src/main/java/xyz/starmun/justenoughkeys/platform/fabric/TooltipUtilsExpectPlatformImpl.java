...
public class TooltipUtilsExpectPlatformImpl {
    ...
    public static void renderTooltip(BaseComponent component, PoseStack poseStack,  int mouseX, int mouseY, int screenWidth, int screenHeight,  Font font){
        drawHoveringText(poseStack, Collections.singletonList(component), mouseX, mouseY, screenWidth, screenHeight, 0, DEFAULT_BACKGROUND_COLOR, DEFAULT_BORDER_COLOR_START, DEFAULT_BORDER_COLOR_END, font);
}

    //Borrowed from forge
    public static void drawHoveringText(PoseStack pStack, List<? extends FormattedText> textLines, int mouseX, int mouseY,
